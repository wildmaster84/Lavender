...
public enum EntityType implements Keyed {
    ...
    WANDERING_TRADER, FROG, EXPERIENCE_BOTTLE, TNT, TNT_MINECART,
    FIREWORK_ROCKET,COMMAND_BLOCK_MINECART, CHEST_MINECART, CHEST, FURNACE_MINECART,
    HOPPER_MINECART, SPLASH_POTION, LINGERING_POTION, END_CRYSTAL,
    SPRUCE_CHEST_BOAT, SPRUCE_BOAT, BIRCH_CHEST_BOAT, BIRCH_BOAT, ACACIA_CHEST_BOAT,
    ACACIA_BOAT, DARK_OAK_CHEST_BOAT, DARK_OAK_BOAT, MANGROVE_BOAT, MANGROVE_CHEST_BOAT,
    CHERRY_BOAT, CHERRY_CHEST_BOAT, PALE_OAK_BOAT, PALE_OAK_CHEST_BOAT, BAMBOO_RAFT,
    BAMBOO_CHEST_RAFT, JUNGLE_BOAT, JUNGLE_CHEST_BOAT, ARMADILLO, BREEZE, CAMEL_HUSK,
    HAPPY_GHAST, BOGGED, COPPER_GOLEM, CREAKING, NAUTILUS, ZOMBIE_NAUTILUS, SNOW_GOLEM, 
    SNIFFER, PARCHED, TRADER_LLAMA, ZOMBIE_VILLAGER;
