...
public abstract class PotionEffectType {
    ...
    public static final PotionEffectType SLOW_FALLING = null;
    public static final PotionEffectType CONDUIT_POWER = null;
    public static final PotionEffectType DOLPHINS_GRACE = null;
    public abstract int getId();
    public abstract String getName();
    public abstract boolean isInstant();
    public abstract org.bukkit.Color getColor();
    public static PotionEffectType getById(int id) { return null; }
    public static PotionEffectType getByName(String name) { return null; }
    public static PotionEffectType[] values() { return new PotionEffectType[0]; }
}
